...
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_fast_d.py \
#     --config config/grpo.py:discriminator_sd3_fast
...
accelerate launch --config_file scripts/accelerate_configs/deepspeed_zero2.yaml \
    --num_machines 1 --num_processes 1 \
    --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
    scripts/train_sd3_fast_dino_patch_few_images.py \
...
#     --num_machines 1 --num_processes 8 \
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_fast_dinov3_patch_few_images.py \
#     --config config/grpo.py:dinov3_cotrain_sd3_patch_fast
...
#     --num_machines 1 --num_processes 8 \
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_fast_siglip_patch_few_images.py \
#     --config config/grpo.py:siglip_cotrain_sd3_patch_fast
...
#     --num_machines 1 --num_processes 8 \
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_fast_dino_diffusion.py \
#     --config config/grpo.py:diffusion_cotrain_sd3_fast
...
#     --num_machines 1 --num_processes 1 \
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_fast_diffusion.py \
#     --config config/grpo.py:diffusion_cotrain_sd3_fast
...
#     --num_machines 1 --num_processes 8 \
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_fast_ref.py \
#     --config config/grpo.py:dino_sd3_fast
...
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_fast_ref.py \
#     --config config/grpo.py:general_geneval_sd3_fast
...
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_fast.py \
#     --config config/grpo.py:general_ocr_sd3_fast
...
#     --num_machines 1 --num_processes 1 \
#     --machine_rank ${RANK} --main_process_ip ${MASTER_ADDR} --main_process_port ${MASTER_PORT} \
#     scripts/train_sd3_flux_offline.py \
#     --config config/grpo.py:ocr_sd3_qwen
